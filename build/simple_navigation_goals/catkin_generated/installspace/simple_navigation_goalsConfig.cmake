...
if("FALSE" STREQUAL "TRUE")
  set(simple_navigation_goals_SOURCE_PREFIX /home/gac/gazebo2-pioneer/src/simple_navigation_goals)
  set(simple_navigation_goals_DEVEL_PREFIX /home/gac/gazebo2-pioneer/devel)
  ...
  set(simple_navigation_goals_INSTALL_PREFIX /home/gac/gazebo2-pioneer/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gac/gazebo2-pioneer/install/${idir}'.  Ask the maintainer 'jchu2041 <jchu2041@todo.todo>' to fix it.")
    endif()
