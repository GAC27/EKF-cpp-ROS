...
if("TRUE" STREQUAL "TRUE")
  set(pioneer_ros_SOURCE_PREFIX /home/tiago/Untitled Folder 2/SistemasAutonomos/src/pioneer_gazebo_ros/pioneer_ros)
  set(pioneer_ros_DEVEL_PREFIX /home/tiago/Untitled Folder 2/SistemasAutonomos/devel)
  ...
  set(pioneer_ros_INSTALL_PREFIX /home/tiago/Untitled Folder 2/SistemasAutonomos/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pioneer_ros' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tiago/Untitled Folder 2/SistemasAutonomos/src/pioneer_gazebo_ros/pioneer_ros/${idir}'.  Ask the maintainer 'jchu2041 <jchu2041@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pioneer_ros_dep}_FOUND)
      find_package(${pioneer_ros_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pioneer_ros_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
