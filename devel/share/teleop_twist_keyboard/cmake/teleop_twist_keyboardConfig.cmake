...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gac/gazebo2-pioneer/src/teleop_twist_keyboard/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>' to fix it.")
    endif()
